...
def add_pujetid_sf(
    ...
    add_pujetid_weight(
        ...
        year=year,
        year_mod=yearmod,
        working_point=bjets_selection[region][lepton_flavor]["btag_working_point"],
        variation=variation,
    )
...
def add_btag_sf(
    ...
    btag_corrector = BTagCorrector(
        ...
        weights=weights_container,
        sf_type="comb",
        worging_point=bjets_selection[region][lepton_flavor]["btag_working_point"],
        tagger="deepJet",
        year=year,
        year_mod=yearmod,
        full_run=False,
...
def add_lepton_sf(
    ...
    electron_corrector.add_id_weight(
        id_working_point=electron_selection[region][lepton_flavor][
            "electron_id_wp"
        ]
    )
    ...
    muon_corrector = MuonCorrector(
        ...
        year_mod=yearmod,
        variation=variation,
        id_wp=muon_selection[region][lepton_flavor]["muon_id_wp"],
        iso_wp=muon_selection[region][lepton_flavor]["muon_iso_wp"],
    )
    # add muon ID weights
